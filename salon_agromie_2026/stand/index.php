...
if (empty($_SESSION['user_id']) || ($_SESSION['role'] ?? '') !== 'stand_manager') {
...
<div class="container stand-shell">
  <div class="card-premium stand-card p-4 p-md-5">
    <div class="text-center mb-4">
      <h1 class="hero-title mb-2">Validation Stand</h1>
      <p class="small-muted mb-0">Scan des étudiants par le responsable du stand</p>
    </div>
    ...
    <div class="operator-box mb-4">
      <div class="row g-3">
        ...
        <div class="col-md-4">
          <strong>ID stand</strong><br>
          <?= htmlspecialchars((string)($_SESSION['stand_id'] ?? '-')) ?>
        </div>
      </div>
    </div>
    ...
    <div class="row g-4">
      <div class="col-lg-7">
        ...
        <div class="d-grid gap-2 d-md-flex">
          <button class="btn btn-premium btn-green flex-fill" onclick="scanStandStudent()">
...
async function scanStandStudent(){
  ...
  try{
    const response = await fetch("../api/visits.php?action=scan_stand", {
      method: "POST",
      body: formData
    });
