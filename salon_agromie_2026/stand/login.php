...
<head>
  ...
  <title>Identification Responsable Stand</title>
...
<div class="container py-5" style="max-width:600px;">
  <div class="card-premium p-4 p-md-5">
    <h1 class="hero-title mb-2">Responsable de Stand</h1>
    <p class="text-muted mb-4">Renseignez votre identité avant de commencer le scan.</p>

    <div class="mb-3">
      <label class="form-label">Nom complet</label>
      <input type="text" id="operator_full_name" class="form-control" placeholder="Ex : Rakoto Jean Michel">
    </div>

    <div class="mb-3">
      <label class="form-label">Promotion</label>
      <input type="text" id="operator_promotion" class="form-control" placeholder="Ex : L3 Agro">
    </div>
